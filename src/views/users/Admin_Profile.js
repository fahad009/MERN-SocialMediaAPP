...
export default class Creator_Profile extends Component {
    ...
    render() {
        const {isLoading, isSubmitted, first_name, last_name, email, public_key, private_key} = this.state;
                        ...
                        <CCard>
                            <CCardBody>
                                ...
                                <CForm onSubmit={this.handleSubmit} className="form-horizontal">
                                    ...
                                    {/*    <CCol xs={'12'} md={'6'}>*/}
                                    {/*        <CFormGroup>*/}
                                    {/*            <CLabel htmlFor="public_key">Stripe Public Key</CLabel>*/}
                                    {/*            <CInput id="public_key" name="public_key" value={public_key}*/}
                                    {/*                    onChange={this.onValueChange}*/}
                                    {/*                    placeholder={'Stripe Public Key'} required/>*/}
                                    {/*        </CFormGroup>*/}
                                    {/*    </CCol>*/}
                                    {/*    <CCol xs={'12'} md={'6'}>*/}
                                    {/*        <CFormGroup>*/}
                                    {/*            <CLabel htmlFor="private_key">Stripe Public Key</CLabel>*/}
                                    {/*            <CInput id="private_key" name="private_key" value={private_key}*/}
                                    {/*                    onChange={this.onValueChange}*/}
                                    {/*                    placeholder={'Stripe Private Key'} required/>*/}
                                    {/*        </CFormGroup>*/}
                                    {/*    </CCol>*/}
                                    {/*</CRow>*/}
