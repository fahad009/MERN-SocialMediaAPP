...
export default class InAppPurchases extends Component {
    ...
    componentDidMount() {
        let logs = [], stories = [], users = [], creators = [];
        db.get().then((querySnapshot) => {
            ...
            this.setState({isLoading: false, logs: logs, stories: stories, users: users, creators: creators});
        });
    }

    render() {
        const { isLoading, logs, stories, users, creators } = this.state;
