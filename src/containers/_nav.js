...
const admin_nav = [
    {
        ...
        name: 'Home',
        to: '/dashboard',
        icon: <CIcon content={freeSet.cilHome} customClasses="c-sidebar-nav-icon"/>
    },
    {
        _tag: 'CSidebarNavItem',
        name: 'My Profile',
        ...
        _children: [
            {
                ...
                to: '/logs/in-app-purchases',
            },
            {
                _tag: 'CSidebarNavItem',
                name: 'Creator Payments',
                to: '/logs/creator-payments',
            }
        ],
    },
    {
        ...
        _children: [
            {
                ...
                to: '/utils/push-notifications',
            },
            {
                _tag: 'CSidebarNavItem',
                name: 'Genre Picker - A/B',
                to: '/utils/genre-picker-ab',
            }
        ],
    }
];
        ...
        _children: [
            {
                _tag: 'CSidebarNavItem',
                name: 'In-App Purchases',
                to: '/creator/logs/in-app-purchases',
            },
            {
                _tag: 'CSidebarNavItem',
                name: 'Payments',
                to: '/creator/logs/payments',
            }
        ],
    }
]
